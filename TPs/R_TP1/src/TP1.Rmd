...
author:
  - Yoann Pradat, PhD yoann.pradat@gustaveroussy.fr
...
clinic_sub <- TcgaDataBin$CLINIC[TcgaDataBin$CLINIC$Project_TCGA == cancer_type_1, ]
# Ensure expression data matches the subset rows
exp_sub <- TcgaDataBin$EXP[rownames(clinic_sub), ]
...
- Train Standard Logistic Regression (glmnet, alpha=0, lambda=0).
